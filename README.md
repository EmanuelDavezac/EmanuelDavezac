<h1 align="center">Hi, I'm Emanuel Davezac <img src="https://media.giphy.com/media/hvRJCLFzcasrR4ia7z/giphy.gif" width="35"></h1>
<img align="right" alt="GIF" height="160px" src="https://media.giphy.com/media/Ah3zHH7hvsSB2/giphy.gif" />

Junior Software Developer | Building web applications & cloud solutions

- 💻 Building projects with **Python**, **JavaScript**, and **Next.js**.
- 📚 Currently exploring modern frontend architectures and TypeScript in personal projects.
- 🗄️ Managing databases and cloud backends with **PostgreSQL**, **Supabase**, and **Neon**.
- 🚀 Focused on writing clean code, solving practical problems, and shipping real projects.
